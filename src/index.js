...
class IconUmbrella extends React.Component {
 render() {
   return (
     <svg className="umbrella" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" aria-labelledby="title">
...
class Board extends React.Component {
  ...
  handleClick(i) {
    ...
    squares[i] = this.state.xIsNext ? <IconUmbrella /> : 'O';
    this.setState({
      squares: squares,
